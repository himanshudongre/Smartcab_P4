# Smartcab_P4
Using reinforcement learning techniques for a self-driving agent in a simplified world to aid it in effectively reaching its destinations in the allotted time.
...
##### environment.py:
This Python file will create the smartcab environment.

##### planner.py: 
This Python file creates a high-level planner for the agent to follow towards a set goal.
...
## Deliverables
1. The agent.py Python file with all code implemented as required in the instructed tasks.
2. A PDF project report 
